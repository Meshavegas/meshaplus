...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      {...props}>
      <>{children}</>
      <Icon name="fa6:chevron-down" aria-hidden={true} className="text-muted-foreground size-4" />
    </SelectPrimitive.Trigger>
  );
}
    ...
    <SelectPrimitive.Item
      ...
      <View className="absolute right-2 flex size-3.5 items-center justify-center">
        <SelectPrimitive.ItemIndicator>
          <Icon name="fa6:check" className="text-muted-foreground size-4 shrink-0" />
        </SelectPrimitive.ItemIndicator>
      </View>
...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpButton
      ...
      {...props}>
      <Icon name="fa6:chevron-up" className="size-4" />
    </SelectPrimitive.ScrollUpButton>
  );
}
...
function SelectScrollDownButton({
  ...
  return (
    <SelectPrimitive.ScrollDownButton
      className={cn('flex cursor-default items-center justify-center py-1', className)}
      {...props}>
      <Icon name="fa6:chevron-down" className="size-4" />
    </SelectPrimitive.ScrollDownButton>
  );
}
