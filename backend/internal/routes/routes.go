...
func SetupRoutes(
	...
	financeDashboardHandler *handler.FinanceDashboardHandler,
	...
	r.Route("/api/v1", func(r chi.Router) {
		...
		// Routes pour le tableau de bord financier (protégées)
		SetupFinanceRoutes(r, financeDashboardHandler, authMiddleware)
